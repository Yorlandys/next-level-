...
class CommitWidget extends StatefulWidget {
  const CommitWidget({super.key});

  @override
  State<CommitWidget> createState() => _CommitWidgetState();
}

class _CommitWidgetState extends State<CommitWidget>
    with TickerProviderStateMixin {
  late CommitModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CommitModel());
