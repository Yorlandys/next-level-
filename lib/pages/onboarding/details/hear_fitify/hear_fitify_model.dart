...
import 'dart:math';
import 'hear_fitify_widget.dart' show HearFitifyWidget;
...
class HearFitifyModel extends FlutterFlowModel<HearFitifyWidget> {
  ...
  // Model for HabitsCard component.
  late HabitsCardModel habitsCardModel7;
  // Model for HabitsCard component.
  late HabitsCardModel habitsCardModel8;
  // Model for HabitsCard component.
  late HabitsCardModel habitsCardModel9;
  // Model for HabitsCard component.
  late HabitsCardModel habitsCardModel10;
  ...
  void initState(BuildContext context) {
    ...
    habitsCardModel7 = createModel(context, () => HabitsCardModel());
    habitsCardModel8 = createModel(context, () => HabitsCardModel());
    habitsCardModel9 = createModel(context, () => HabitsCardModel());
    habitsCardModel10 = createModel(context, () => HabitsCardModel());
  }
  ...
  void dispose() {
    ...
    habitsCardModel7.dispose();
    habitsCardModel8.dispose();
    habitsCardModel9.dispose();
    habitsCardModel10.dispose();
  }
}
