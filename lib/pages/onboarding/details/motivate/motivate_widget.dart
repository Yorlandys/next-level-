...
class MotivateWidget extends StatefulWidget {
  const MotivateWidget({super.key});

  @override
  State<MotivateWidget> createState() => _MotivateWidgetState();
}

class _MotivateWidgetState extends State<MotivateWidget>
    with TickerProviderStateMixin {
  late MotivateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MotivateModel());
